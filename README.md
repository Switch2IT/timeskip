...
4. This will deploy `target/timeskip.ear` to the running instance of the server.
...
You should see messages similar to the following:
    ...
    INFO  [be.ehb.controller.MemberRegistration] (http--127.0.0.1-8080-2) Registering Jane Doe
    INFO  [be.ehb.test.MemberRegistrationTest] (http--127.0.0.1-8080-2) Jane Doe was persisted with id 1
    ...
    INFO  [org.jboss.as.connector.subsystems.datasources] (MSC service thread 1-5) JBAS010409: Unbound data source [jboss/datasources/timeskipTestDS]
